...
import BreadcrumbArrowLight from '../../assets/breadcrumb-arrow-light.svg';
import BreadcrumbArrowDark from '../../assets/breadcrumb-arrow-dark.svg';
      ...
      {versionedPluginEntries.map(([pluginId, docsData]) => {
        ...
        return (
          <select
            ...
            {(docsData as any).versions.map((version: any, i: number) => (
              <option
                key={i}
...
const breadcrumbsArrows = {
  light: BreadcrumbArrowLight as unknown as string,
  dark: BreadcrumbArrowDark as unknown as string,
};
    ...
    <Layout>
      ...
      <div
              ...
              (
                {
                  ...
                  breadcrumbs: { html: string | TrustedHTML }[];
                },
                i: number
              ) => (
                  ...
                  {breadcrumbs.length > 0 && (
                    <nav aria-label="breadcrumbs">
                      <ul
                        ...
                        {breadcrumbs.map(
                          (html: string | TrustedHTML, index: number) => (
                            <>
                              <li
                                key={index}
        ...
        {searchResultState.hasMore && (
          <div className={styles.loader} ref={setLoaderRef as any}>
            <Translate
